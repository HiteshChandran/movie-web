...
import Person from "./project9 movie/Components/Person/index";
...
const App = () => {
  ...
  {/* Render search results globally so they appear on any page */}
  {search.length > 0 && <SearchRow title={search} searchList={searchList} />}
          ...
          <Route
            ...
            element={
              <>
                ...
                {/* Search Results are rendered globally above Routes */}
